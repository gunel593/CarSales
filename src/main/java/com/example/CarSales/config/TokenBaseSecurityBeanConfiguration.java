...
public class TokenBaseSecurityBeanConfiguration {
    private final UserMybatisRepo userMybatisRepo;

    @Bean
    public UserDetailsService userDetailsService(){
        return username -> userMybatisRepo.findByUsername(username).orElseThrow(()->new UsernameNotFoundException("User not found in db"));
    }
    @Bean
